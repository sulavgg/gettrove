...
const CreateGroup = () => {
      ...
      <div className="min-h-screen bg-background px-4 py-6 safe-area-top">
        ...
        <div className="max-w-md mx-auto text-center">
          ...
          <p className="text-muted-foreground mb-6">
            You need to verify your email address before creating groups. Check your inbox at{" "}
  ...
  return (
    <div className="min-h-screen bg-background px-4 py-6 safe-area-top">
      ...
      <div className="max-w-md mx-auto">
        <h1 className="text-2xl font-black text-foreground mb-2">Create a Group</h1>
        <p className="text-muted-foreground mb-8">Start a new habit challenge with friends</p>
        ...
        <form onSubmit={handleCreate} className="space-y-6">
          ...
          <div>
            ...
            <Input
              ...
              required
            />
            <p className="text-xs text-muted-foreground mt-1">{name.length}/30 characters</p>
          </div>

          {/* Habit Type */}
          <div>
            <label className="block text-sm font-medium text-muted-foreground mb-2">HABIT</label>
          ...
          {habitType === "other" && (
            <div>
              <label className="block text-sm font-medium text-muted-foreground mb-2">CUSTOM HABIT NAME</label>
              <Input
                value={customHabit}

  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="mb-10 text-center animate-fade-in flex flex-col items-center">
        <h1 style={{ fontFamily: "'DM Serif Display', serif", fontSize: '32px', fontWeight: 700, letterSpacing: '0.02em', color: '#C9A84C' }}>
          Trove
        </h1>
          ...
          <div className="flex gap-1 mb-6 p-1 bg-muted/30 rounded-xl">
            <button
              ...
              className={`flex-1 py-3 px-4 rounded-lg font-semibold text-sm transition-all duration-300 ${
                mode === 'login' ? 'bg-gold text-gold-foreground shadow-md' : 'text-muted-foreground/50 hover:text-muted-foreground'
              }`}
